      ...
      >
        ...
        >
          ...
          <Typography variant="body1" sx={{ mt: 2 }}>
            안녕하세요. 얼리어답터, 패스트러너, 제너럴리스트 조윤환입니다. 최신
            IT 기술이나 하드웨어에 관심이 많아 해외 직구, 베타 소프트웨어등을
            통해 먼저 써보고 기술의 원리를 탐구하기 좋아합니다. 그리고
            2017년부터 Serverless Framework 등 최신 기술들을 빠르게 사용해보며
            기술에 대한 시야를 넓혔습니다. 이러한 경험들을 바탕으로 현재
            스타트업 프론트엔드 개발 경력 4년차 근무중이며, 이전에는 마크업
            개발자로 4년간 근무하며 가장 근본적인 웹표준 마크업과 웹접근성 부터
            프론트엔드 기술 Stack 다수를 경험했습니다. 그리고 회사 내 전반적인
            개발 인프라(AWS) 관리, 주요 프로젝트 설계에도 참여하여 인프라
            레벨에서 엔드유저의 화면까지 전체적인 개발 라이프사이클을 경험하며
            최상의 사용자 경험을 만들어낼 수 있도록 노력하였습니다.
          </Typography>
          <Box
            sx={{
              display: "flex",
